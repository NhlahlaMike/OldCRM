...
$sql= "select S_Name, SalesID from dbo.Sales_Rep where Employee_status = '1'";
...
$('#sales').change(updateFormEnabled);

$('#lead').change(updateFormEnabled);
</script>



  <title>manager view leads multi step</title>
</head>
<body onkeypress="handleEnter(event)">
  <div class="container">
	...
	<fieldset>
        ...
        Select Sales Rep: <select id ="sales" name="Sales_name" style="width: 200px;" required>
...
Select Status of lead: <select id = "lead" name="lead_status" style="width: 200px;" required>
...
Select the month: <select id ="month" name="month" style="width: 200px;" required>
...
<div style="margin-left: 45%">
  <font size="3"> <input id="submit" type="submit" name="submit" value="View leads" onClick="validation()"></font>
   </div>
...
AND datename(MM, a.stMonth) = '$month'";
   ...
   echo "<font size='3'><strong>You have selected sonsultant: ".$Sales_name."</strong></font>";
...
echo "<font color=#E92326 size='4'><strong><center> NB: YOU CAN NOT VIEW THE GRAPH BEFORE YOU TABLE VIEW A SALES REPRESENTATIVE</center></font></strong>"
