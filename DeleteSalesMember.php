...
$stmt = sqlsrv_query( $conn, $sql );
       ...
       echo '<div id="success" class="alert alert-success">Email Successfully</div>';
}
...
<div class="container">   
   ...
   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <br> 
    <Input type = 'Radio' Name ='EmpStatus' id="Employed" value= 'Employed' 
    <?PHP echo $female_status; ?>
    >Employed    
    <br>
     
    <Input type = 'Radio' Name ='EmpStatus' id ="Released" value= 'Released' 
