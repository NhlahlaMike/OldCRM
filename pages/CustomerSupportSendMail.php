...
<fieldset>
<legend><h5 align="center"><font  color="#cccc00" face="Segoe" size="+6">Customer Support</font></h5></legend>
<div class="container"> 

<form action="" method="post">
Name: <br><input type="text" name="first_name" placeholder="Enter your name">
<br>
Contact no:<br> <input type="number" name="contact_number" placeholder="Cellphone number">
<br>
Email:<br> <input type="text" name="email" placeholder="Enter your email address">
<br>
