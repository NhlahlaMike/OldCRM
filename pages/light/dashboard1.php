...
<div class="wrapper">
  ...
  <div class="dropdown">
  <button class="dropbtn"><i class="pe-7s-menu"></i>Sale  Manager Menu</button>
  <div class="dropdown-content">
   
      <role="presentation" class="divider">
 <li role="presentation" class="dropdown-header"><i class="pe-7s-menu"></i>Sales Manager Menu</i></li>
 <li role="presentation" class="divider"></li>
  <a href="LeadsRep.php"><i class="pe-7s-news-paper"></i>Leads Report</a></li>
    <a href="ViewInvoice.php"><i class="pe-7s-display2"></i>View invoicing report</a></li>
    <a href="AddProdRange.php"><i class="pe-7s-server"></i>Add product range</a></li>
   <a href="CaseReport.php"><i class="pe-7s-note2"></i>Case reports</a></li>
   <a href="ViewPerSales.php"><i class="pe-7s-id"></i>Leads per-sales</a></li>
   <a href="task.php"><i class="pe-7s-users"></i>Tasks per-sales</a></li>
 <li role="presentation" class="divider"></li>
 ...
 <a href="ADDSALE.php"><i class="pe-7s-upload"></i>Add sales</a>
   ...
   <li role="presentation" class="dropdown-header"><i class="pe-7s-menu"></i>Admin Menu</li>
    <li role="presentation" class="divider"></li>
      <a href="load1.php"><i class="pe-7s-upload"></i>Import</a></li>
     <a href="confirmInv.php"><i class="pe-7s-cash"></i>Confirm Invoice</a></li>
    
     <li role="presentation" class="dropdown-header"><i class="pe-7s-menu"></i>Sales Menu</li>
 <role="presentation" class="divider">
       <a href="load.php"><i class="pe-7s-upload"></i>Import</a>
      <a href="manual.php"><i class="pe-7s-id"></i>Manual Registration</a>
      <a href="viewedit.php"><i class="pe-7s-note2"></i>View/Edit Customers</a>
     <a href="viewleads.php"><i class="pe-7s-albums"></i>View Leads</a>
</div>
</div>
</div>
</li>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Sales Manager Menu</a>
                </div>
