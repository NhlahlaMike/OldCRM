...
<div class="container">
<div class="dropdown">
  <button class="dropbtn"><i class="pe-7s-menu"></i>Admin menu</button>
  <div class="dropdown-content">
  
    
    <li role="presentation" class="dropdown-header"><i class="pe-7s-menu"></i>Admin Menu</i></li>
    ...
    <li role="presentation" class="divider"></li>
      ...
      <a href="manual.php"><i class="pe-7s-id"></i>Manual registration</a></li>
