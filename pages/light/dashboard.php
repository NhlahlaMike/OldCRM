...
<div class="wrapper">
    ...
    <!--
        ...
        Tip 1: you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple | #cccc00"
...
<div class="container">
  ...
  <div class="dropdown">
  <button class="dropbtn"><i class="pe-7s-menu"></i>Sales Menu</button>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Sale menu</a>
                </div>
