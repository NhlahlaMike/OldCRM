...
$sql="SELECT * FROM dbo.Sales_Rep where Employee_status != '0' and SalesID !='$sid'";
...
<div class="container">   
   ...
   <h3> Please select employee status view: </h3>   
    ...
    <input type="text" name="Sales_ID" value="Search with SalesID" 
           onkeyup="myFunction(this.id)" onclick="TClear(this.id)" id="Sales_ID" onblur="TBlur(this.id);" size="16">  
        Search Name:  
    <input type="text" name="Name_Text" value="Search with Name" 
            onkeyup="myFunction(this.id)" onclick="TClear(this.id)" id="Name_Text" onblur="TBlur(this.id);" size="14">
         
        Search Surname:
    <input type="text" name="Surname_Text" value="Search with Surname"
           onkeyup="myFunction(this.id)" onclick="TClear(this.id)" id="Surname_Text" onblur="TBlur(this.id);" size="17">
     <br><br>   
    Clicked_SalesID:&nbsp; &nbsp;
    <input class="selectedText" type="text" name="lname" id="lname" readonly>
    <input class="selectedText" type="hidden" name="fname" id="fname" readonly>
       <br><br>
