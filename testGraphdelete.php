...
<body>
  <div class="container">
	...
	<fieldset>
        ...
        Select Sales Rep: <select name="Sales_name" style="width: 200px;" required>
...
Select the month: <select name="month" style="width: 200px;" required="required">
...
echo "<font color=#E92326 size='4'><strong><center> NB: YOU CANNOT VIEW THE GRAPH BEFORE YOU TABLE VIEW A SALES REPRESENTATIVE</center></font></strong>"
